...
const insertCountryCultures = async (countriyID, cultures) => {
  return connect("countries", async (collection) => {
    return await collection.updateOne({ _id: countriyID }, { $set: { cultures: cultures } });
  });
};

module.exports = { getCountries, insertCountries, insertCities, insertCountryCultures };
